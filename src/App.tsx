...
`}
              ...
              <ul>
                ...
                <li>
                  <code>commandsPath</code> – Path where all your command files
                  are found
                </li>
                <li>
                  <code>eventsPath</code> – Path where all your event files are
                  found
                </li>
                <li>
                  <code>messagesPath</code> – Path where your predefined custom
                ...
                <li>
                  <code>connectionUri</code> – A uri to connect to your database
                  so AeroClient can store data
                </li>
                <li>
                  <code>useDefaults</code> – Flag to enable default commands and
                  settings
                </li>
                <li>
                ...
                <li>
                  <code>disableStaffCooldowns</code> - Flag to allow people
                  allowed in{" "}
                  <code>
                ...
                <ul>
                  <li>
                    <code>cooldown</code> – Reponse to send when the command is
                    on cooldown
                  </li>
                  <li>
                  ...
                  <li>
                    <code>nsfw</code> – Response to send when an NSFW command is
                    used in a SFW channel
                  </li>
                  <li>
                  ...
                  <li>
                    <code id="staff">staff</code> – Response to send when a
                    non-staff user attempts to use a staff only command
                  </li>
                  <li>
                  ...
                  <li>
                    <code>perms</code> - Response to send when someone attempts
                    to run a command but doesn't have sufficient permissions
                  </li>
                </ul>
                <li>
                ...
                <li>
                  <code>customHandler</code> – A callback to use instead of our
                  command handler
                </li>
                <li>
                  <code>readyCallback</code> – A callback to use instead of our
...
`}</code>
              ...
              <span className="red">@param</span> <code>path</code> – Path to
              the JSON file
              <br />
              <br />
              <br />
...
`}</code>
              ...
              <p>
                Calling the next function without any parameters will allow
                other middleware to execute, like express.
                <br />
                However, if you pass in <code>true</code>, the middleware stops
              ...
              <ul>
                ...
                <li>
                  <code>dmOnly</code> – If the command can only be executed in a
                  direct message
                </li>
                <li>
                  <code>nsfw</code> – If the command can only be executed in an
                  NSFW channel
                </li>
                <li>
                  <code>hidden</code> – If the command should be hidden from the
                  default help command
                </li>
                <li>
                  <code>guarded</code> - If the command should be protected from
                  being disabled
                </li>
                <li>
...
`}</code>
              ...
              <span className="red">@param</span> <code>showFlags</code> – Flag
              to show flags or not.
...
`}</code>
              ...
              <span className="red">@param</span> <code>string</code> – String
              to format
              <br />
              <pre>
                <code>{`\
...
`}</code>
              ...
              trim
              <br />
              <span className="red">@param</span> <code>length</code> – Max
...
`}</code>
              ...
              <ul>
                ...
                <li>
                  <code>fastForwardAndRewind</code> – Enables two extra features
                  with options
                  <ul>
                    <li>
                    ...
                    <li>
                      <code>rewindPrompt</code> – Custom prompt to ask when
                      rewinding
                    </li>
                    <li>
                      <code>fastForwardPrompt</code> – Custom prompt to ask when
                      fast forwarding
                    </li>
                  </ul>
                </li>
